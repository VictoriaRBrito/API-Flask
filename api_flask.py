...
api = Api(app)  # Initializing flask api


class Users(Resource):  # user endpoint
    def get(self):
    ...
    def post(self):
        # initialize the request parser, to use the arguments in the request
...
class Locations(Resource):  # location endpoint
    def get(self):
